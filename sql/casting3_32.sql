DROP DATABASE `casting3`;CREATE DATABASE `casting3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;USE `casting3`; -- MySQL dump 10.13  Distrib 5.5.20, for Win64 (x86)
--
...
CREATE TABLE `application` (
  `application_id` bigint(100) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `application_ibfk_4` FOREIGN KEY (`characterid`) REFERENCES `character` (`characterid`),
  CONSTRAINT `application_ibfk_1` FOREIGN KEY (`videoid`) REFERENCES `video` (`videoid`),
  CONSTRAINT `application_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `user_account` (`userid`),
  CONSTRAINT `application_ibfk_3` FOREIGN KEY (`casting_callid`) REFERENCES `casting_call` (`casting_callid`)
...
CREATE TABLE `favourite_artiste_portfolio` (
  ...
  CONSTRAINT `favourite_artiste_portfolio_ibfk_2` FOREIGN KEY (`artiste_portfolioid`) REFERENCES `character` (`characterid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-08-10 15:29:00
