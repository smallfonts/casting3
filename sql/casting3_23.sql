DROP DATABASE `casting3`;CREATE DATABASE `casting3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;USE `casting3`; -- MySQL dump 10.13  Distrib 5.5.24, for Win32 (x86)
--
...
CREATE TABLE `artiste_portfolio` (
  ...
  `skillsid` varchar(255) DEFAULT NULL,
...
CREATE TABLE `character_language` (
  ...
  KEY `characterid` (`characterid`,`languageid`),
...
--
-- Table structure for table `favourite_searched_artiste_portfolio`
--

DROP TABLE IF EXISTS `favourite_searched_artiste_portfolio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `favourite_searched_artiste_portfolio` (
  `userid` bigint(100) NOT NULL,
  `artiste_portfolioid` bigint(100) NOT NULL,
  KEY `userid` (`userid`),
  KEY `artiste_portfolioid` (`artiste_portfolioid`),
  CONSTRAINT `favourite_searched_artiste_portfolio_ibfk_2` FOREIGN KEY (`artiste_portfolioid`) REFERENCES `character` (`characterid`),
  CONSTRAINT `favourite_searched_artiste_portfolio_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user_account` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `favourite_searched_character`
--

DROP TABLE IF EXISTS `favourite_searched_character`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `favourite_searched_character` (
  `userid` bigint(100) NOT NULL,
  `characterid` bigint(100) NOT NULL,
  KEY `userid` (`userid`),
  KEY `characterid` (`characterid`),
  CONSTRAINT `favourite_searched_character_ibfk_2` FOREIGN KEY (`characterid`) REFERENCES `character` (`characterid`),
  CONSTRAINT `favourite_searched_character_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user_account` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `skills` (
  `skillsid` bigint(100) NOT NULL,
  `skillsDesc` varchar(255) NOT NULL,
  `artiste_portfolioid` bigint(100) NOT NULL,
  PRIMARY KEY (`skillsid`,`skillsDesc`,`artiste_portfolioid`),
  KEY `artiste_portfolioid` (`artiste_portfolioid`),
  CONSTRAINT `skills_ibfk_1` FOREIGN KEY (`artiste_portfolioid`) REFERENCES `artiste_portfolio` (`artiste_portfolioid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-07-10 12:17:10
