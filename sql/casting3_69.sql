DROP DATABASE `casting3`;CREATE DATABASE `casting3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;USE `casting3`; -- MySQL dump 10.13  Distrib 5.5.8, for Win32 (x86)
--
...
-- Dump completed on 2012-10-26 22:05:07
