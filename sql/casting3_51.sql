...
CREATE TABLE `artiste_portfolio` (
  ...
  `portfolio_guide` int(11) DEFAULT '0',
...
CREATE TABLE `audition_interviewee_slot` (
  ...
  KEY `artiste_portfolioid` (`artiste_portfolioid`),
  CONSTRAINT `audition_interviewee_slot_ibfk_3` FOREIGN KEY (`artiste_portfolioid`) REFERENCES `artiste_portfolio_photo` (`artiste_portfolioid`),
...
CREATE TABLE `casting_call_invitation` (
  ...
  `statusid` bigint(100) DEFAULT NULL,
...
-- Dump completed on 2012-10-02 13:59:46
