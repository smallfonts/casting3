...
CREATE TABLE `character_language` (
  ...
  CONSTRAINT `character_language_ibfk_3` FOREIGN KEY (`language_proficiencyid`) REFERENCES `spoken_language` (`language_proficiencyid`),
...
-- Dump completed on 2012-08-15 11:58:37
