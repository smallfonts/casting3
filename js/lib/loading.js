...
(function($){
    ...
    $.fn.loading = function(isLoading,callback){
        ...
        if(!isLoading) {
            data.spinner.stop();
            obj = this;
            this.find('#loader').fadeOut(function(){
        ...
        this.prepend("<div id='loader' style='opacity:0.3;background:#D4D4D4;position:absolute;height:"+this.height()+"px;width:"+this.width()+"px;z-index:1000'></div>");
        ...
        var opts = {
            ...
            zIndex: 101, // The z-index (defaults to 2000000000)
            top: 'auto', // Top position relative to parent in px
            left: 'auto' // Left position relative to parent in px
        };

        this.find('#loader').fadeIn(function(){
            setTimeout(function(){
                if(callback) callback();
            },1000);
        });
        
        data.spinner = new Spinner(opts).spin(this[0]);
    }
