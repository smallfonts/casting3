...
<span ng-controller="apply_ctrl">
    ...
    <div class="row-fluid" ng-model="application">
        ...
        <div class="row-fluid line">
            <div class="span5">
                <h1>Apply for Casting Call</h1>
            </div>
            <div class="span7">
                <div class="pull-right">
                    <a class="btn btn-medium {{submitBtnDisabled}}" ng-click="saveDraft()"><i class="icon-briefcase"></i> Save Draft</a>
                    <a class="btn btn-medium {{submitBtnDisabled}}" ng-click="submitApplication()"><i class="icon-folder-open"></i> Submit Application</a>
                    <a class="btn btn-medium {{submitBtnDisabled}}" ng-click="confirmWithdrawApplication()"><i class="icon-remove"></i> Delete Application</a>
        ...
        <div class="c3-group" style="margin-bottom:10px;">
            <div class="header header-warning" style="padding-left:10px"><h3>Step 1: Edit Your Personal Information</h3></div>
            <div class="body" style="padding:10px;">
                <div class="row-fluid">
                    <div class="span4">
                    ...
                    <div class="span8">
                        <button class="btn btn-medium btn-primary pull-right" ng-click="editPortfolio()"><i class="icon-edit icon-white"></i> Click Here To Edit Personal Information</button>
                    </div>
                </div>
                <div class="tab-content" style="height:auto;opacity:0.6">
        ...
        <div class="c3-group" ng-show="hasPhotos() || hasVideos()">
            <div class="header header-warning" style="padding-left:10px"><h3>Step 2: Upload Required Attachments</h3></div>
            ...
            <div ng-show="hasPhotos()" class="body" style="padding:0px;margin-bottom:-15px">
                <table class="table table-hover casting-call-list">
                    ...
                    <tr ng-repeat="retPhoto in retPhotos">
                        ...
                        <td id="featuredPhoto{{retPhoto.id}}" style="width:100px;height:100px;">
                            <div class="addImage" ng-show="!retPhoto.attachment" style="margin:0px;width:100px;height:100px">
                                <h6>No Image</h6>
                            </div>
                            <span ng-show="retPhoto.attachment" class="thumbnail c3-well-tiny"><img ng-src="{{photoBaseUrl + '/l' + retPhoto.attachment}}" alt=""/></span>
                            <button class="btn btn-medium btn-primary {{uploadPhotoClass}}" style="margin-top:5px" ng-click="changeFeaturedPhoto(retPhoto.id)">Upload Photo</button>
                        </td>
                    </tr>
                ...
                <table class="table table-hover casting-call-list">
                    ...
                    <tr ng-repeat="retVideo in retVideos">
                        ...
                        <td style="width:100px;padding-top:0px">
                            <div class="thumbnail c3-well-tiny" style="margin-top:5px" ng-hide="!retVideo.attachment">
                                <img ng-src="http://img.youtube.com/vi/{{retVideo.attachment}}/0.jpg"></img>
                            </div>
                            <div class="addImage" ng-show="!retVideo.attachment" style="margin:0px;width:100px; height:100px">
                                <h6>No Video</h6>
                            </div>
                            <button class="btn btn-medium btn-primary" style="margin-top:10px" ng-click="addVideo(retVideo.id)">Upload Video</button>
                        </td>
                    </tr>
