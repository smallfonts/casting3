    ...
    <table>
        <tr>
            ...
            <td class="third_column">
                <a id="changeEmail" data-toggle="modal" class="btn btn-info btn-mini" ng-click="changeEmail()">Change</a>
            </td>
        </tr>
        <tr>
            ...
            <td class="third_column">
                <a id="changePassword" data-toggle="modal" class="btn btn-info btn-mini" ng-click="changePassword()">Change</a>
