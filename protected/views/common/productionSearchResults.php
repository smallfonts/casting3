...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/controllers/view_prod_results_ctrl.js"></script>
<script>
    
    var jsonResults = <?php echo $jsonResults; ?>;
    
</script>
<span ng-controller="view_prod_results_ctrl">
                ...
                <div class="casting_call row-fluid">
                    ...
                    <div class="span8">
                        ...
                        <div style="text-align:justify;">
                                ...
                                <div class="thumbnail span4" ng-repeat="result in jsonResults">
                                    <img src="{{baseUrl + '/images/photos/' + result.photoUrl}}">
                                    <div class="span3">
